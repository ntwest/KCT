...
namespace Expressive
{
    internal sealed class ExpressionParser
    {
        ...
        internal ExpressionParser(ExpressiveOptions options)
        {
            ...
            _stringComparer = ((_options & ExpressiveOptions.IgnoreCase) == ExpressiveOptions.IgnoreCase)
            ...
            RegisterFunction(new LnFunction());
        ...
        {
            return (((options & ExpressiveOptions.IgnoreCase) == ExpressiveOptions.IgnoreCase) &&
        ...
        {
            return ((options & ExpressiveOptions.IgnoreCase) == ExpressiveOptions.IgnoreCase) ? StringComparer.OrdinalIgnoreCase : StringComparer.Ordinal;
        }
