...
namespace Expressive.Functions.String
{
    internal class EndsWithFunction : FunctionBase
    {
        ...
        public override object Evaluate(IExpression[] parameters, ExpressiveOptions options)
        {
            ...
            return text?.EndsWith(value, ((options & ExpressiveOptions.IgnoreCase) == ExpressiveOptions.IgnoreCase) ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal) == true;
        }
