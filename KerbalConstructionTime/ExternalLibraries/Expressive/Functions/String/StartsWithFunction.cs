...
namespace Expressive.Functions.String
{
    internal class StartsWithFunction : FunctionBase
    {
        ...
        public override object Evaluate(IExpression[] parameters, ExpressiveOptions options)
        {
            ...
            return text?.StartsWith(value, ((options & ExpressiveOptions.IgnoreCase) == ExpressiveOptions.IgnoreCase) ? StringComparison.OrdinalIgnoreCase : StringComparison.Ordinal) == true;
        }
