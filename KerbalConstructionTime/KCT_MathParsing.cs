...
namespace KerbalConstructionTime
{
    public class KCT_MathParsing
    {
        ...
        public static double ParseBuildRateFormula(BuildListVessel.ListType type, int index, SpaceCenterConstruction KSC, bool UpgradedRates = false)
        {
        ...
        public static double ParseNodeRateFormula(double ScienceValue, int index = 0, bool UpgradedRates = false)
        {
            ...
            int upgrades = GameStates.TechUpgradesTotal;
        ...
        public static void AddCrewVariables(Dictionary<string, string> crewVars)
        {
            ...
            //Log.Trace(pilots + " pilots " + pLevels + " levels");
            //Log.Trace(engineers + " engineers " + eLevels + " levels");
            //Log.Trace(scientists + " scientists " + sLevels + " levels");
            ...
            //Log.Trace("Printing crewVars data");
            //foreach (var kvp in crewVars)
            //    Log.Trace(kvp.Key + ":" + kvp.Value);
            //return crewVars;
        }
    }
}
